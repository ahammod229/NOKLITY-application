...
const MobileNav: React.FC<MobileNavProps> = ({ setIsChatbotOpen }) => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 h-16 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 flex justify-around items-center z-40 transition-colors duration-200">
      ...
      <div className="w-full">
        <button
          ...
          className="flex flex-col items-center justify-center w-full h-full relative text-gray-500 dark:text-gray-400 hover:text-orange-500 transition-colors"
      ...
      <div className="w-full flex justify-center">
         <Link to="/wishlist" className="-mt-6">
            <div className="relative w-16 h-16 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center border-t-2 border-gray-200 dark:border-gray-700 transition-colors duration-200">
